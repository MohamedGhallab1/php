...
<body>
    ...
    <?php
    $employees = [
        ["nom" => "omar", "poste" => "Développeur", "salaire" => 10000],
        ["nom" => "ali", "poste" => "Designer", "salaire" => 9500],
        ["nom" => "Youssef", "poste" => "Manager", "salaire" => 15000],
        ["nom" => "sara", "poste" => "Testeur", "salaire" => 4000],
    ...
    $utilisateurs = [
        ...
        ["email" => "test2@gmail.com", "mot_de_passe" => "salam123"],
        ["email" => "test3@gmail.com", "mot_de_passe" => "1234567898"],
    ];
